...
Examples:
  mmeshctl cp localhost:/tmp/file.txt acc1:default:n1:subnet-000:node1:/tmp/
  mmeshctl cp localhost:/tmp/dir/ acc1:default:n1:subnet-000:node1:/tmp/dir/
  mmeshctl cp acc1:default:n1:subnet-000:node1:/tmp/dir1/ localhost:/tmp/dir2/
  mmeshctl cp acc1:default:n1:subnet-000:node1:/tmp/f.txt localhost:/tmp/dir3/
