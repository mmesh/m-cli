...
var cloudAppAddCmd = &cobra.Command{
	...
	Long:  `Add a cloud app to your mmesh interactively.`,
	Args:  cobra.NoArgs,
...
var cloudAppDeleteCmd = &cobra.Command{
	...
	Long:  `Remove a cloud app from your mmesh.`,
	Args:  cobra.NoArgs,
	Run: func(cmd *cobra.Command, args []string) {
